...
//type MemoryState = (Seq[CardView], UserId, Option[UserId], Seq[UserId]) // Change this!
case class MemoryState(memory: MemoryView, winner: Option[UserId], clients: Seq[UserId], cartes: Seq[Card])
